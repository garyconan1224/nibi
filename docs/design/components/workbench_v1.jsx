...
const Workbench = ({ onStart, onOpenWorkspace, onSeeAllWorkspaces }) => {
    ...
    <>
      ...
      <section className="examples">
        <div className="examples-head">
          <h2 className="display" style={{margin:0, fontSize:36}}>最近工作空间</h2>
          <button className="btn btn-ghost" onClick={onSeeAllWorkspaces}>
            全部 · {VM_DATA.TASKS.length} <IcArrowRight size={14}/>
          </button>
        </div>
        <div style={{
          display:'grid',
