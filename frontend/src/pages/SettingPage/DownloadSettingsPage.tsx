...
const DownloadSettingsPage = () => {
  ...
  return (
    <div className="mx-auto max-w-3xl space-y-8 p-6">
      <div>
        <h1 className="text-[28px] font-semibold tracking-tight">{t('download.title')}</h1>
      ...
      <Section
        ...
        title={t('download.storageTitle')}
        description={t('download.storageDescription')}
      >
        <FieldRow
          htmlFor="output-dir"
          ...
          <div className="space-y-3">
            ...
            <div className="flex flex-wrap gap-2">
              {filenamePresets.map((preset) => (
                <Button
                  key={preset.value}
                  variant={draft.filenameTemplate === preset.value ? 'default' : 'outline'}
                  size="sm"
            ...
            {/* 模板预览 */}
            <div className="rounded bg-zinc-50 p-2 text-xs text-muted-foreground">
      ...
      <Section
        ...
        title={t('download.networkTitle')}
        description={t('download.networkDescription')}
      >
        <FieldRow
          htmlFor="proxy"
      ...
      <Section
        ...
        description={t('download.advancedDescription')}
      >
        <FieldRow
