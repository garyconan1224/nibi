"""Phase 2.3.a — 分析视图（从 pages/2_视频分析.py 正文搬运）。

- 已去除：st.set_page_config、st.sidebar 后端地址展示、页面级项目切换器 UI
- 保留：全部辅助函数（_analysis_result_paths / _render_visual_json_result / _init_state 等）
- 签名：render_analyze_view(project_id: str) -> None
"""
...
def render_analyze_view(project_id: str) -> None:
    """分析视图：从 pages/2_视频分析.py 搬运而来，去除 set_page_config / sidebar / 项目切换器。"""
